...
from ldm.modules.diffusionmodules.openaimodel import \
    TimestepBlock, TimestepEmbedSequential, Upsample, Downsample, AttentionBlock
...
class VASCA_UNetModel(nn.Module):
    """
