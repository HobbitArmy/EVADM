"""
Calculates relative-FID to evalulate on real-sr datasets.
...
def calculate_rfid_given_paths(paths, batch_size, device, dims, num_workers=1):
    ...
    # path: [hr_path, sr_path, up_path]
    m0, s0 = compute_statistics_of_path(paths[0], model, batch_size,
                                        dims, device, num_workers)
    m1, s1 = compute_statistics_of_path(paths[1], model, batch_size,
                                        dims, device, num_workers)
    m2, s2 = compute_statistics_of_path(paths[2], model, batch_size,
                                        dims, device, num_workers)
